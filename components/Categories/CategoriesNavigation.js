...
export default function CategoriesNavigation({ navigation }) {
   ...
   const { name, color } = route.params; // Receive data
   ...
   const handleAddExpense = () => {
      ...
      navigation.navigate('AddExpensesCategories', { category2: name });
   };
   ...
   return (
      <SafeAreaView style={styles.container}>
         ...
         <View style={styles.header}>
            ...
            <Text style={[styles.headerTitle, { textAlign: 'center' }]}>{name}</Text>
         </View>
