...
const TransactionsIncome = () => {
   ...
   const mainScreenTranslate = sidebarAnimation.interpolate({
      inputRange: [0, 1],
   ...
   return (
      <SafeAreaView style={styles.container}>
         ...
         <View style={styles.statsContainer}>
            <TouchableOpacity style={styles.statCard1}>
               <UpArrowIcon />
               <Text style={styles.statLabel}>Income</Text>
               <Text style={styles.incomeAmount}>₹4,120.00</Text>
            </TouchableOpacity>

            <TouchableOpacity style={styles.statCard2} onPress={() => navigation.navigate("TransactionsExpense")}>
               <DownArrowIcon />
